        ...
        <div className="relative z-10 max-w-2xl mx-auto space-y-10">
          ...
          <div className="pt-6">
            <a
              ...
              className="inline-flex items-center gap-2 px-10 py-5 bg-primary text-surface font-semibold rounded-full hover:scale-105 hover:shadow-apple-hover transition-all text-lg tracking-wide"
            >
